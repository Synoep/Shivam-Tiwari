...
const Projects: NextPage = (props: any) => {
  ...
  return (
    ...
    >
      <Head>
        <title>Projects - Shivam Tiwari</title>
        <meta
          name="description"
          content="Portfolio showcasing my software development projects and skills."
        />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Projects - Shivam Tiwari" />
        <meta
          name="description"
          content="Portfolio showcasing my software development projects and skills."
        />
        <link rel="canonical" href={"https://shivamtiwari.com"} />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={"https://shivamtiwari.com"} />
