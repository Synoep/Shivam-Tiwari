...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Shivam Tiwari | Software Development Engineer</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={
            "Shivam Tiwari - Software Development Engineer &amp; Product Developer"
          }
        />
        <meta
          name="description"
        ...
        <div className="container vscodecontainer mx-auto max-w-5xl w-full p-6 mb:p-12">
          <div className="flex flex-col mt-1 md:flex-row md:space-x-4">
            <div className="flex-1 mb-4 md:mb-0 ">
              <div className="p-2">
                <h2 className="text-5xl font-sans	 mb-2 ">Shivam Tiwari</h2>
              ...
              >
                ...
                <div className="mt-4">
                  <Link passHref target="_blank" href="https://leetcode.com/u/synoep/">
                    ...
                    >
                      <img src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/28/null/external-level-up-your-coding-skills-and-quickly-land-a-job-logo-color-tal-revivo.png" />
                      <p className="text-gray-200 text-sm  font-sans flex justify-start items-center">
                        LeetCode Profile
                      </p>
                    </div>
                ...
                <div className="mt-4">
                  ...
                  >
                      <img src="https://img.icons8.com/color/28/null/codechef.png" />
                    <p className="text-gray-200 text-sm  font-sans flex justify-start items-center">
                        CodeChef Profile
                    </p>
                  </div>
                ...
                <div className="mt-4">
                  ...
                  >
                      <img src="/codeforces.png" width="28" height="28" />
                    <p className="text-gray-200 text-sm  font-sans flex justify-start items-center">
                        CodeForces Profile
                    </p>
                  </div>
